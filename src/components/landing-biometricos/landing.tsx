        ...
        <>
            <div className='landing-container'>
                ...
                <div className='landing-content'>
                    ...
                    {/*Mobile*/}
                    <div className='landing-images d-md-none'>
                        <img src='/static/images/img-landing-biometricos-movil.png' alt='landing'></img>
                    </div>

                    {/*Desktop*/}
                    <div className='landing-images d-none d-md-block'>
                        ...
                        <div className='tabs-container'>
                            <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                                <Tabs
                                    ...
                                    <Tab label={LL.landingBiometricos.productos.devices()} {...a11yProps(0)} className='tab-item' />
                                    <Tab label={LL.landingBiometricos.productos.software()} {...a11yProps(1)} className='tab-item' />
